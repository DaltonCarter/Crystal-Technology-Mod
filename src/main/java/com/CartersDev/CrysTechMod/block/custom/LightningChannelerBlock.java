...
import com.CartersDev.CrysTechMod.container.LightningChannelerContainer;
import com.CartersDev.CrysTechMod.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.crystechmod.lightning_channeler");
            }
