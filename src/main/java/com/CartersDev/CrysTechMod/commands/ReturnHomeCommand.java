package com.CartersDev.CrysTechMod.commands;
...
public class ReturnHomeCommand {
    ...
    private int returnHome(CommandSource source) throws CommandSyntaxException {
        ...
        boolean hasHomepos = player.getPersistentData().getIntArray(CrystalTech.MOD_ID + "homepos").length != 0;

        if(hasHomepos) {
            int[] playerPos = player.getPersistentData().getIntArray(CrystalTech.MOD_ID  + "homepos");
